import svgPaths from "./svg-xyaeul4jje";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon-bell">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon-bell">
          <g id="Shape">
            <path clipRule="evenodd" d={svgPaths.p29458e00} fill="currentColor" fillRule="evenodd" />
            <path d={svgPaths.p350ce580} fill="currentColor" />
          </g>
        </g>
      </svg>
    </div>
...
function IconCalendar() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon-calendar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon-calendar">
          <path clipRule="evenodd" d={svgPaths.p3ee81400} fill="currentColor" fillRule="evenodd" id="Shape" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon-clock">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon-clock">
          <g id="Shape">
            <path d={svgPaths.p32a5b600} fill="currentColor" />
            <path clipRule="evenodd" d={svgPaths.pc72a700} fill="currentColor" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function IconEyeOff() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon-eye-off">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_2242_901)" id="icon-eye-off">
          <g id="Shape">
...
function IconSettings() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon-settings">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_2242_1001)" id="icon-settings">
          <g id="Shape">
            <path clipRule="evenodd" d={svgPaths.p279efa80} fill="#707070" fillRule="evenodd" />
...
// Export role icons
export { AvatarRole, AvatarRole1, AvatarRole2 };
